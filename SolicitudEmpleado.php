...
<body>
    ...
    <br>
    <div id="Menu">
        <form action="AccionSE.php" method="GET">
            ...
            <input type="image" onclick="alert('Vacaciones solicitadas');" img id="vacaciones" src="https://1.bp.blogspot.com/-p6cIipYAgGA/YT5yPa6uunI/AAAAAAAAAG4/2eSTNncnLGErU5vdgOTusQJgN1Qj0OY_ACNcBGAsYHQ/s0/IconoSolicitarVa.png" style="float: right;" />
